...
SYSTEM_PROMPT = (
    ...
    "  HOT-EXTREME gap (>=-.080): Fades HR hard. Also flag hits — regression likely on BOTH.\n"
    "  HOT-EXTREME gap (>=-.120): FADE BOTH HR AND HITS. At this magnitude xwOBA is so much lower\n"
    "    than wOBA that BABIP luck is almost certainly driving results. Crash incoming.\n"
    "    Example: wOBA .433 + xwOBA .274 = gap -.159 = about to crash on hits too.\n"
